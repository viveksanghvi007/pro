...
const ReviewPage = () => {
  ...
  const fetchReviews = async () => {
    try {
      ...
      const response = await reviewAPI.getByCompany(id, params);
  ...
  const handleAddReview = async (reviewData) => {
    try {
      ...
      // Refresh both company data and reviews
      await Promise.all([fetchCompany(), fetchReviews()]);
    } catch (err) {
              ...
              <form onSubmit={handleSearch}>
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2 pl-10 pr-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  />
